...
// 힌트 : 이거는 구성으로 푸는것 입니다.
public class WarriorTest { // T는 테스트를 의미
...
class 전사T {
    ...
    void 공격T(String attackerName, String weaponName) {
        this.lastAttackerName = attackerName;
        this.lastWeaponName = weaponName;

        공격출력문구(attackerName, weaponName);
    }

    void 재공격T() {
        공격출력문구(this.lastAttackerName, this.lastWeaponName);
    }

    void 공격출력문구(String attackerName, String weaponName) {
